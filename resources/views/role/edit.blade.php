                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{route('role.update', ['id' => $role->id])}}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" value="{{$role->name}}" name="name" placeholder="Role Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="description" class="col-md-3 form-label">Role Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="description" placeholder="Role Description">{{$role->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <button class="btn btn-primary rounded-0" type="submit">Update Role Info</button>
                    </form>
                </div>
            </div>
        </div>
