                                    ...
                                    <div class="car-dealer-form-inner">
                                        ...
                                        <form action="#" class="ltn__car-dealer-form-box row">
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-adult col-md-3">
                                                <select class="nice-select" style="color: #5C727D;">
                                            ...
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-adult col-md-3">
{{--                                                <input class="form-control form-control-solid nice-select btn_width" placeholder="Pick date rage" id="kt_daterangepicker_1">--}}
...
{{--                                                <p id="endDate">End Date:</p>--}}
                                            ...
                                            <div class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-adult col-md-3">
                                                <div class="dropdown">
                                                    <selector class="nice-select" data-bs-toggle="dropdown">Guests</selector>
{{--                                                    <div class="dropdown-menu w-100 rounded-0" style="font-family: Poppins">--}}
        ...
        <div class="container">
            ...
            <div class="row ltn__product-slider-item-three-active slick-arrow-1">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="{{route('detail')}}"><img src="{{asset('/')}}website/img/product-3/5.jpg" alt="#"></a>
                        </div>
                        <div class="product-info">
                            <div class="product-badge">
                                <ul>
                            ...
                            <h2 class="product-title"><a href="{{route('detail')}}">3 BEd Room Family Flat at Baridhara</a></h2>
                            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                                <li><span>24/7 </span>
                                    Lift & Generator
                                </li>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="{{route('detail')}}"><img src="{{asset('/')}}website/img/product-3/6.jpg" alt="#"></a>
                        </div>
                        <div class="product-info">
                            <div class="product-badge">
                                <ul>
                            ...
                            <h2 class="product-title"><a href="{{route('detail')}}">4 Bed Full Apartment at Aftabnagar</a></h2>
                            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                                <li><span>247 </span>
                                    Lift & Generator
                                </li>
...
{{--    <!-- Date Picker Plugin -->--}}
{{--    <script src="{{asset('/')}}website/js/plugins.bundle.js"></script>--}}
    <!-- Date Picker Plugin -->
    <script src='https://cdn.jsdelivr.net/jquery/latest/jquery.min.js'></script>
    <script src='https://cdn.jsdelivr.net/momentjs/latest/moment.min.js'></script>
    <script src='https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js'></script>
    <script  src="{{asset('/')}}website/js/datepicker-script.js"></script>
