                ...
                <div class="col-lg-8 col-md-12">
                    <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                        ...
                        <div class="ltn__property-details-gallery mb-30">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="{{asset('/')}}website/img/others/14.jpg" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{asset('/')}}website/img/others/14.jpg" alt="Image">
                                    </a>
                                    <a href="{{asset('/')}}website/img/others/15.jpg" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{asset('/')}}website/img/others/15.jpg" alt="Image">
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{asset('/')}}website/img/others/16.jpg" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{asset('/')}}website/img/others/16.jpg" alt="Image">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <a href="cart.html">
                                <button type="submit" class="btn theme-btn-1">Add to Cart</button>
                            </a>
                        </div>


                        <div class="ltn__shop-details-tab-content-inner--- ltn__shop-details-tab-inner-2 ltn__product-details-review-inner mb-60 pt-50">
                                ...
                                <div class="ltn__comment-inner">
                                    <ul>
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="{{asset('/')}}website/img/testimonial/1.jpg" alt="Image">
                                                </div>
                                        ...
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="{{asset('/')}}website/img/testimonial/3.jpg" alt="Image">
                                                </div>
                                                <div class="ltn__commenter-comment">
                                                    <h6><a href="#">Adam Smit</a></h6>
                                                    <div class="product-ratting">
                                        ...
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="{{asset('/')}}website/img/testimonial/2.jpg" alt="Image">
                                                </div>
                                                <div class="ltn__commenter-comment">
                                                    <h6><a href="#">Adam Smit</a></h6>
                                                    <div class="product-ratting">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-6 col-12">
                                <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                    <div class="product-img">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/product-3/1.jpg" alt="#"></a>
                                        <div class="real-estate-agent">
                                            <div class="agent-img">
                                                <a href="team-details.html"><img src="{{asset('/')}}website/img/blog/author.jpg" alt="#"></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-sm-6 col-12">
                                <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                    <div class="product-img">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/product-3/2.jpg" alt="#"></a>
                                        <div class="real-estate-agent">
                                            <div class="agent-img">
                                                <a href="team-details.html"><img src="{{asset('/')}}website/img/blog/author.jpg" alt="#"></a>
                                            </div>
                    ...
                    <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                        ...
                        <div class="widget ltn__author-widget">
                            <div class="ltn__author-widget-inner text-center">
                                <img src="{{asset('/')}}website/img/team/4.jpg" alt="Image">
                        ...
                        <div class="widget ltn__top-rated-product-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product/1.png" alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product/2.png" alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                                                <ul>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product/3.png" alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                                                <ul>
                        ...
                        <div class="widget ltn__popular-product-widget">
                            ...
                            <div class="row ltn__popular-product-widget-active slick-arrow-1">
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product-3/6.jpg" alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="{{asset('/')}}website/img/blog/author.jpg" alt="#"></a>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product-3/4.jpg" alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="{{asset('/')}}website/img/blog/author.jpg" alt="#"></a>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product-3/5.jpg" alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="{{asset('/')}}website/img/blog/author.jpg" alt="#"></a>
                                                </div>
                        ...
                        <div class="widget ltn__popular-post-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{asset('/')}}website/img/team/5.jpg" alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{asset('/')}}website/img/team/6.jpg" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                    cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{asset('/')}}website/img/team/7.jpg" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                    cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{asset('/')}}website/img/team/8.jpg" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                    cing elit, sed do.</a></h6>
                        ...
                        <div class="widget ltn__banner-widget d-none">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/banner/2.jpg" alt="#"></a>
                        </div>
                    </aside>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row ltn__related-product-slider-two-active slick-arrow-1">
                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{asset('/')}}website/img/product-3/3.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="team-details.html"><img src="{{asset('/')}}website/img/blog/author.jpg" alt="#"></a>
                                </div>
